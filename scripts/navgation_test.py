...
#             NAV_3.add_child(MOVE_BASE['Point3'])
            WAIT4COMMEND=MonitorTask("WAIT4COMMEND", 'speech_sub',Int32,self.wait_for_commend)
            FOLLOW=Follow("FOLLOW")
            NAV_3.add_child(WAIT4COMMEND)
            NAV_3.add_child(FOLLOW)
            NAV_3.add_child(MOVE_BASE['Point3'])
